        ...
        for file_name in files:
            if file_name.endswith(('.jpg', '.jpeg', '.png')):
                ...
                try:
                    ...
                    quantize_image = go_nord.quantize_image(image, save_path=output_path)
                    print(f"Converted {image_path} to Nord palette and saved at {output_path}")
                except Exception as e:
                    print(f"Error processing {image_path}: {e}")

# Specify the folder containing images
input_folder = "E:/Personal/Github/lazy-walls-nord/develop/imagegonord/test"

# Specify the output folder
output_folder = "E:/Personal/Github/lazy-walls-nord/develop/imagegonord/output"
